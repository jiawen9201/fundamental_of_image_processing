...
def restoration2(srcImage1, srcImage1Restored):
    ...
    # adding the fine details 3x back to the original image
    imgA_add = cv.add(imgA_ori, 3*imgA_subtract)
    ...
    imgA_restored = cv.add(imgA_add, imgA_emphasize_edge) # 56.54, 73.13, 70.2
